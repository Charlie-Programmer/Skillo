...
class ViewSuggestionsPage extends StatefulWidget {
  ...
  @override
  State<ViewSuggestionsPage> createState() =>
      _ViewSuggestionsPageState();
}

class _ViewSuggestionsPageState
    extends State<ViewSuggestionsPage> {
                  ...
                  builder: (context, Box box, _) {
                    ...
                    return GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final item = suggestedCourses[index];
